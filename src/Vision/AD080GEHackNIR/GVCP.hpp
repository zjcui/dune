...
#ifndef VISION_AD080GEHACK_GVCP_HPP_INCLUDED_
#define VISION_AD080GEHACK_GVCP_HPP_INCLUDED_
  ...
  namespace AD080GEHackNIR
  {
    ...
    public:
      ...
      enum PixelFormats
      {
        ...
        //! Grayscale, 10 bits per pixel.
        PIX_MONO10         = 0x01100003,
        //! Grayscale, 10 bits per pixel, packed.
        PIX_MONO10_PACKED  = 0x010C0004,
        //! Grayscale, 12 bits per pixel.
        PIX_MONO12         = 0x01100005,
        //! Grayscale, 12 bits per pixel, packed.
        PIX_MONO12_PACKED  = 0x010C0006,

        //! Color RGB, 24 bits per pixel, packed.
        PIX_RGB8_PACKED    = 0x02180014
      };
